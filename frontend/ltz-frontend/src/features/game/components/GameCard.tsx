...
const GameCard = ({
  ...
  return (
      <article
          className={`group overflow-hidden rounded-2xl border border-white/10 bg-slate-950/70 shadow-lg transition-colors hover:border-violet-400/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/70 ${
      ...
      >
        ...
        <div className="space-y-4 p-4">
          ...
          <div className="flex items-center gap-3">
            <a
                className="inline-flex flex-1 cursor-pointer items-center justify-center rounded-lg border border-white/10 bg-slate-900/80 px-4 py-2 text-sm font-semibold text-white transition-colors hover:border-cyan-300/50"
                href={detailPath}
