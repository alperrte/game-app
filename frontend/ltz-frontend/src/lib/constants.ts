...
export const USER_API_ENDPOINTS = {
    ...
    profileById: (userId: number | string) =>
    ...
    adminUserBadges: (userId: string) =>
        `/api/users/admin/${userId}/badges`,
...
export const GAME_API_ENDPOINTS = {
    ...
    categoryById: (id: number | string) =>
        `/api/games/categories/${id}`,

    platforms: "/api/games/platforms",
    platformById: (id: number | string) =>
        `/api/games/platforms/${id}`,

    developers: "/api/games/developers",
    developerById: (id: number | string) =>
        `/api/games/developers/${id}`,

    publishers: "/api/games/publishers",
    publisherById: (id: number | string) =>
        `/api/games/publishers/${id}`,
