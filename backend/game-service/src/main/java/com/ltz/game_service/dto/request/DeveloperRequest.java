...
public class DeveloperRequest {
    ...
    @NotBlank(message = "Geliştirici adı boş bırakılamaz.")
    @Size(max = 150, message = "Geliştirici adı en fazla 150 karakter olabilir.")
    private String name;

    @Size(max = 1000, message = "Geliştirici açıklaması en fazla 1000 karakter olabilir.")
