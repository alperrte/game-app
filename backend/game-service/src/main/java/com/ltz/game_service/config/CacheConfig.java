...
public class CacheConfig {
    ...
    public static final String EXTERNAL_GAME_TAGS = "externalGameTags";
    public static final String EXTERNAL_GAME_SEARCH = "externalGameSearch";
    public static final String EXTERNAL_GAME_POPULAR = "externalGamePopular";
    public static final String EXTERNAL_GAME_APPS = "externalGameApps";
    ...
    public CacheManager cacheManager() {
        ...
        cacheManager.setCaches(List.of(
                ...
                buildCache(EXTERNAL_GAME_TAGS, Duration.ofHours(6), 1000),
                buildCache(EXTERNAL_GAME_SEARCH, Duration.ofMinutes(10), 1000),
                buildCache(EXTERNAL_GAME_POPULAR, Duration.ofMinutes(30), 500),
                buildCache(EXTERNAL_GAME_APPS, Duration.ofHours(6), 1000),
