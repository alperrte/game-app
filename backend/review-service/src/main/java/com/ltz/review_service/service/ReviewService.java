...
public class ReviewService {
    ...
    public ReviewResponse createReview(CreateReviewRequest request, Long authenticatedUserId) {
        ...
        Review review = Review.builder()
                ...
                .graphicsReview(request.getGraphicsReview())
                .gameplayReview(request.getGameplayReview())
                .storyReview(request.getStoryReview())
                .performanceReview(request.getPerformanceReview())
    ...
    private ReviewResponse mapToReviewResponse(Review review) {
        return ReviewResponse.builder()
                ...
                .graphicsReview(review.getGraphicsReview())
                .gameplayReview(review.getGameplayReview())
                .storyReview(review.getStoryReview())
                .performanceReview(review.getPerformanceReview())
                .pros(review.getPros())
                .cons(review.getCons())
