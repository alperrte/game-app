CREATE TABLE deal_campaigns (
    ...
    store_name NVARCHAR(50) NOT NULL, -- 'STEAM', 'EPIC', 'GOG', 'FANATICAL' vb.
...
CREATE INDEX ix_deals_discount_price ON deal_campaigns(discount_percent DESC, discounted_price);
